...
export const dict = {
  ...
  "dialog.provider.opencode.note": "精心策划的模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.anthropic.note": "直接访问 Claude 模型，包括 Pro 和 Max",
  "dialog.provider.copilot.note": "用于编码辅助的 Claude 模型",
  "dialog.provider.openai.note": "用于快速、强大的通用 AI 任务的 GPT 模型",
  "dialog.provider.google.note": "用于快速、结构化响应的 Gemini 模型",
  "dialog.provider.openrouter.note": "从一个提供商访问所有支持的模型",
  ...
  "prompt.placeholder.normal": '想问点什么... "{{example}}"',
  ...
  "session.review.change.one": "变更",
  "session.review.change.other": "变更",
  "session.review.loadingChanges": "正在加载变更...",
  "session.review.empty": "此会话暂无变更",
  "session.review.noChanges": "无变更",
